...
/scripts/point-in-time-restore.sh "2025-11-27 18:23:10"
```
...
docker run --rm \
  ...
  --entrypoint /bin/bash \
  your_image:tag \
  -c "/scripts/point-in-time-restore.sh \"2025-11-27 18:23:10\""
```
...
/scripts/point-in-time-restore.sh "$TARGET_TIME"
```
...
# ❌ 使用 UTC 时间（不推荐，容易混淆）
/scripts/point-in-time-restore.sh "2025-11-27 10:23:10"  # 这是 UTC 时间，不是东8区

# ❌ 格式不正确
/scripts/point-in-time-restore.sh "2025/11/27 18:23:10"  # 日期分隔符错误
/scripts/point-in-time-restore.sh "2025-11-27T18:23:10"  # ISO 格式，不支持
```
...
/scripts/point-in-time-restore.sh "2025-11-27 18:23:09"
```
...
/scripts/point-in-time-restore.sh "2025-11-27 10:23:10"  # UTC 时间
```
...
**最后更新**：2025-11-27  
**适用版本**：point-in-time-restore.sh v1.0+
